...
const SearchSection: FC<SearchSectionType> = ({ part }) => {
  return (
    <Row className="justify-content-between align-items-center footer-head gy-md-0 gy-3">
      <Col lg="5" md="6">
        <h2 className="text-white">{part === "property-2" ? "Find your Next Dream Car Today!" : part === "property-2" ? "Find your Next Dream Home Today!" : "Find your Next Grate Job Opportunity!"}</h2>
      </Col>
      <Col md="6">
