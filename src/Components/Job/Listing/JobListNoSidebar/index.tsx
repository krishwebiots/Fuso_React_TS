...
const JobListNoSidebarContainer = () => {
  return (
    <Fragment>
      ...
      <GridView type="job" sectionClass="job-list-section section-b-space" filterTagsClass="job-list-header" side="no" topFilterSidebar jobBoxStyle="listing" gridSize={1} />
    </Fragment>
  );
};
